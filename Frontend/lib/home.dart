...
class _AQIDashboardPageState extends State<AQIDashboardPage> {
  static const String _baseUrl = 'http://10.112.193.104:5000';  // Updated for Android emulator
...
Future<Map<String, dynamic>> fetchForecast() async {
  final response = await http.get(Uri.parse('http://10.112.193.104:5000/forecast'));
