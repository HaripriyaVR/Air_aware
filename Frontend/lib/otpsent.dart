...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final String backendUrl = 'http://localhost:5000'; // Replace with your backend IP

  Future<void> checkAndSendOtp() async {
    String number = _phoneController.text.trim();

    // ✅ Validate: 10-digit number only (e.g., 9876543210)
    ...
    try {
      ...
      if (result['status'] == 'pending') {
        showSnackbar("✅ OTP sent to $fullPhone");
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ✅ Phone Input Field with +91 prefix
              TextField(
